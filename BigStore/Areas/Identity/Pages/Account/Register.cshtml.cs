        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // https://localhost:5001/Identity/ConfirmEmail?userId=alksjf$code=jkljl$returnUrl=
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Xác nhận email",
                        $"Xác nhận đăng ký tài khoản trên Product Store, hãy <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>bấm vào đây</a> để kích hoạt tài khoản.");
